  ...
  <div class="row">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="small-box bg-white">
        <div class="inner">
          <h3><?php echo(file_get_contents('http://biscuicraft.fr/download/stats/downloadsstats.php')); ?></h3>
          <p>TÉLÉCHARGEMENTS</p>
        </div>
        <div class="icon">
        ...
        <a href="#" class="small-box-footer">
          <?php echo('Total : ' . file_get_contents('http://biscuicraft.fr/download/stats/downloadsstats.php'));  ?>
        </a>
      </div>
    </div>
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="small-box bg-green">
        <div class="inner">
          <h3><?php echo(file_get_contents('https://biscuicraft.fr/app/webroot/launchstats.php')); ?></h3>
          <p>LANCEMENTS</p>
        </div>
        <div class="icon">
        ...
        <a href="#" class="small-box-footer">
          <?php echo('Total : ' . file_get_contents('https://biscuicraft.fr/app/webroot/launchstats.php'));  ?>
        </a>
      </div>
    </div>
